...
const knownRoutes = new Set([
  ...
  '/icy/collection',
  '/icy/outils',
  '/icy/outils/collection',
  '/icy/outils/ressources-minage',
  '/icy/outils/fiches-minage',
  '/icy/outils/executive-hangar',
  '/icy/outils/executive-hangar-players',
  '/icy/outils/executive-hangar-maps',
  '/icy/outils/achat-vaisseaux',
  '/icy/outils/wikelo',
  '/icy/outils/guides',
  '/icy/outils/guides/minage-star-citizen',
  '/icy/outils/guides/minage-avance',
  '/icy/outils/guides/salvage',
  '/icy/outils/guides/hathor',
  '/icy/admin',
  '/icy/admin/members',
