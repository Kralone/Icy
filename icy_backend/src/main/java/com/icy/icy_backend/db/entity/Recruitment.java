...
public class Recruitment {
    ...
    public Recruitment(com.icy.icy_backend.controller.dto.RecruitmentDTO dto) {
        this.id = dto.getId();
    ...
    public void updateFromDto(com.icy.icy_backend.controller.dto.RecruitmentDTO dto) {
        this.username = dto.getUsername();
        this.discordTag = dto.getDiscordTag();
        this.motivation = dto.getMotivation();
        this.referral = dto.getReferral();
